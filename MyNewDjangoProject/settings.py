"""
Django settings for MyNewDjangoProject project.
...
ROOT_URLCONF = 'MyNewDjangoProject.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
             #BASE_DIR / 'templates',  # Added my templates directory
...
WSGI_APPLICATION = 'MyNewDjangoProject.wsgi.application'
...
STATICFILES_DIRS = [
    BASE_DIR / "static",  # adding the base directory of  my project here
]
